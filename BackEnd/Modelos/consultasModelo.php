...
<html lang="es">
	...
	<div class="fondo123">
		...
		<?PHP
			...
			ECHO "<TABLE BORDER =1 frame=below id='tabla'>";
				...
				while ($i=$row=sqlsrv_fetch_array($resultado, SQLSRV_FETCH_ASSOC)){
					...
					$nombre_modelo = $row ['descripcion_modelo'];
					
					
					//3.3 Imprimir resutados
					ECHO "<TR>";
						ECHO "<TD hidden>".$id_modelo."</TD>";
						ECHO "<TD>".$nombre_modelo."</TD>";
						ECHO "<TD> <a href='form_modif.php?id_modelo=".$id_modelo ."&descripcion_modelo=".$nombre_modelo."'><img src='../Sinaloense_files/modificar.png'></a></td>";
						echo "<TD> <a href='eliminarModelo.php?id_modelo=".$id_modelo."'><img src='../Sinaloense_files/eliminar.png'></a></td>";
					ECHO "</TR>";
				}
				ECHO "</TBODY>";
		...
		<br>
		<br>
		<a href="Form_modelo.php">Insertar nuevo registro</a>
