...
<html lang="es">
	...
	<div class="fondo123">
		<div class="container"> 
			...
			<H1> C O N S U L T A S    S U B C A T E G O R I A S </H1>
		...
		<?PHP
			...
			if ($conexion) {//si hubo conexion
				...
				$resultado = sqlsrv_query($conexion, "exec spSeleccionarSubcategoria");
			...
			ECHO "<TABLE BORDER =1 frame=below id='tabla'>";
				ECHO "<THEAD>";
				ECHO "<TH hidden> id_subcategoria </TH>";
				...
				while ($i=$row=sqlsrv_fetch_array($resultado, SQLSRV_FETCH_ASSOC)){
					...
					$categoria_subcategoria = $row ['nombre_categoria'];
					
					//3.3 Imprimir resutados
					ECHO "<TR>";
						ECHO "<TD hidden>".$id_subcategoria."</TD>";
						ECHO "<TD>".$nombre_subcategoria."</TD>";
						ECHO "<TD>".$categoria_subcategoria."</TD>";
						ECHO "<TD> <a href='form_modif.php?id_subcategoria=".$id_subcategoria ."&nombre_subcategoria=".$nombre_subcategoria."&categoria_subcategoria=".$categoria_subcategoria."'><img src='../Sinaloense_files/modificar.png'></a></td>";
						echo "<TD> <a href='eliminarSubCat.php?id_subcategoria=".$id_subcategoria."'><img src='../Sinaloense_files/eliminar.png'></a></td>";
					ECHO "</TR>";
				}
				ECHO "</TBODY>";
		...
		<br>
		<br>
		<a href="Form_SubCat.php">Insertar nuevo registro</a>
