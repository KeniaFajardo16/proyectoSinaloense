		...
		<div class="fondo123">
			<div class="container"> 
				<ul class="two-rows">
					...
					<H1>Formulario de salidas</H1>
					<FORM ACTION= "insertSalidas.php" METHOD="POST" CLASS="formulario">
						<LABEL> Fecha </LABEL>
						...
						<SELECT name="refaccion_salida">
							<?php
								...
								if ($conexion)
								{
									$resultado = sqlsrv_query($conexion,"exec spSeleccionarTabla @tabla=Refacciones");
									if ($resultado){
										while($row = sqlsrv_fetch_array($resultado,SQLSRV_FETCH_ASSOC))
										{
											$id_refaccion = $row['folio_refaccion'];
											$descripcion = $row ['descripcion_refaccion'];
											echo "<option value='".$id_refaccion."'>".$descripcion."</option><br>";
										}
									}
								}
							?>
						...
						<INPUT TYPE="number" NAME="cantidad_salida" min="1" value="1"/>
						</br>
						</br>
						<LABEL> Almacen </LABEL>
