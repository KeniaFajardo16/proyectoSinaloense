<html>
	...
	<div class="fondo123">
		<div class="container"> 
			...
			<H1> C O N S U L T A S    U S U A R I O S  </H1>
	...
	<?PHP
		...
		if ($banderaconexion == true){
			...
			$resultado = sqlsrv_query($conexion,"exec spSeleccionarUsuario");
		...
		ECHO "<TABLE BORDER = '1' frame='below' id='tabla'>";
			...
			while ($row=sqlsrv_fetch_array($resultado, SQLSRV_FETCH_ASSOC)){
				...
				ECHO "<TR>";
					ECHO "<TD hidden>".$id_usuario."</TD>";
					ECHO "<TD>".$nombre_usuario."</TD>";
					ECHO "<TD>".$tipo_usuario."</TD>";
					ECHO "<TD>".$usuario."</TD>";
					ECHO "<TD>".$password."</TD>";
					ECHO "<TD> <a href='formModif.php?id_usuario=".$id_usuario ."&nombre_usuario=".$nombre_usuario."&tipo_usuario=".$tipo_usuario."&usuario=".$usuario."&pass=".$password."'><img src='../Sinaloense_files/modificar.png' alt='Modificar registro'></a></td>";
					echo "<TD> <a href='eliminarUsuarios.php?id_usuario=".$id_usuario."'><img src='../Sinaloense_files/Eliminar.png' alt='Eliminar registro'></a></td>";
				ECHO "</TR>";
			}
			ECHO "</TBODY>";
		ECHO "</TABLE>";
	...
	<br>
	<br>
	<a href="form_usuarios.php">Insertar nuevo registro</a>
		</div> 
	</div>
