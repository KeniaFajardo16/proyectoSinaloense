<?php 
	...
	$descripcion_anio =$_GET['descripcion_anio'];
?>
<html>
	<head>
	...
	<div class="fondo123">
		<div class="container"> 
			...
			<form action = "modificarAnio.php" METHOD="POST" class="formulario">
			<!--Cajas de texto !-->
				
			<label>Id Año</label>
			<input TYPE ="TEXT" NAME = "id_anio" 
			value = <?php echo "".$id_anio."" ?> 
			/>
			</br>
				
			<label>Descripcion Año</label>
			<input TYPE ="TEXT" NAME = "descripcion_anio" 
			value = <?php 
			echo "".$descripcion_anio."" ?> />
			</br>
