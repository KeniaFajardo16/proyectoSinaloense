...
<html lang="es">
	...
	<div class="fondo123">
		<div class="container"> 
			...
			<H1> C O N S U L T A S    P R O V E E D O R E S </H1>
			...
			<?PHP
				...
				if ($conexion) {//si hubo conexion
					...
					$resultado = sqlsrv_query($conexion, "exec spSeleccionarProveedor");
				...
				ECHO "<TABLE BORDER =1 frame=below id='tabla'>";
					ECHO "<THEAD>";
						ECHO "<TH hidden> id_proveedor </TH>";
						ECHO "<TH> RFC </TH>";
					...
					while ($i=$row=sqlsrv_fetch_array($resultado, SQLSRV_FETCH_ASSOC)){
						...
						$ciudad_proveedor = $row['nombre_ciudad'];
						$telefono_proveedor = $row ['telefono_proveedor'];
						$cp_proveedor = $row ['cp_proveedor'];
						
						//3.3 Imprimir resutados
						ECHO "<TR>";
							ECHO "<TD hidden>".$id_proveedor."</TD>";
							ECHO "<TD>".$rfc_proveedor."</TD>";
							ECHO "<TD>".$nombre_proveedor."</TD>";
							ECHO "<TD>".$ciudad_proveedor."</TD>";
							ECHO "<TD>".$telefono_proveedor."</TD>";
							ECHO "<TD>".$cp_proveedor."</TD>";
							ECHO "<TD> <a href='form_modif.php?id_proveedor=".$id_proveedor ."&rfc_proveedor=".$rfc_proveedor."&nombre_proveedor=".$nombre_proveedor."&ciudad_proveedor=".$ciudad_proveedor."&telefono_proveedor=".$telefono_proveedor."&cp_proveedor=".$cp_proveedor."'><img src='../Sinaloense_files/modificar.png'></a></td>";
							echo "<TD> <a href='eliminarProveedor.php?id_proveedor=".$id_proveedor."'><img src='../Sinaloense_files/eliminar.png'></a></td>";
						ECHO "</TR>";
					}
					ECHO "</TBODY>";		
				ECHO "</TABLE>";
		...
		<br>
		<br>
		<a href="Form_Proveedor.php">Insertar nuevo registro</a>
