...
<html lang="es">
	...
	<div class="fondo123">
		<div class="container"> 
			...
			<H1> C O N S U L T A S    C A T E G O R I A S </H1>
		...
		<?PHP
			...
			if ($banderaconexion == true){
				...
				$resultado = sqlsrv_query($conexion, "exec spSeleccionarTabla @tabla=?",$param);
			...
			ECHO "<TABLE BORDER =1 frame=below id='tabla'>";
				ECHO "<THEAD>";
				ECHO "<TH hidden> id_categoria </TH>";
				...
				while ($i=$row=sqlsrv_fetch_array($resultado, SQLSRV_FETCH_ASSOC)){
					...
					ECHO "<TR>";
						ECHO "<TD hidden>".$id_categoria."</TD>";
						ECHO "<TD>".$nombre_categoria."</TD>";
						ECHO "<TD> <a href='form_modif.php?id_categoria=".$id_categoria ."&nombre_categoria=".$nombre_categoria."'><img src='../Sinaloense_files/modificar.png'></a></td>";
						echo "<TD> <a href='eliminarCategoria.php?id_categoria=".$id_categoria."'><img src='../Sinaloense_files/eliminar.png'></a></td>";
					ECHO "</TR>";
				}
				ECHO "</TBODY>";	
			ECHO "</TABLE>";
		...
		<br>
		<br>
		<a href="Form_categoria.php">Insertar nuevo registro</a>
